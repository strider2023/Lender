...
import com.mbv.pokket.dao.enums.DeviceType;
import com.mbv.pokket.dao.enums.OSType;
 ...
 */
public abstract class AppTask extends AsyncTask<String, Void, ServerEvents> {
    ...
    public AppTask(int id, Context context, ServerResponseListener serverResponseListener){
        ...
        this.mProgress.setMessage(context.getText(R.string.loan_id));
