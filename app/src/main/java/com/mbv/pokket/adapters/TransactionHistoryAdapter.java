...
public class TransactionHistoryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.adapter_transaction_history, parent, false);
            holder.name = (TextView) convertView.findViewById(R.id.transaction_history_name);
            holder.amount = (TextView) convertView.findViewById(R.id.transaction_history_amount);
            holder.tenure = (TextView) convertView.findViewById(R.id.transaction_history_tenure);
            holder.postTime = (TextView) convertView.findViewById(R.id.transaction_history_post_time);
